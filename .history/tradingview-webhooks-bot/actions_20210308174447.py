...
def send_order(data):
    ...
    #binance_derrick.futures_create_order(symbol=symbol,side='SELL',type='MARKET',quantity=quantity)
    #binance_aba.futures_create_order(symbol=symbol,side='SELL',type='MARKET',quantity=quantity)
